...
{/*--------------------------- overlay text ---------------------------*/}
            <div className="card absolute sm:relative sm:w-full w-[643px] h-[443px] sm:h-auto rounded-lg bg-[#FFF3E3] pt-[35px] pl-[45px] pr-[45px] pb-[50px] sm:px-5 sm:py-4 flex flex-col mt-[190px] sm:mt-0 sm:text-center sm:mb-10">
                <p className="updates font-semibold text-lg tracking-wide">New Arrival</p>
                <h2 className="heading font-bold text-[52px] text-[#B88E2F] mb-3">Discover Our
                    <br /> New Collection</h2>
                <p className="paragraph font-medium text-[18px] text-[#333333] mb-[45px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut <br />elit tellus, luctus nec ullamcorper mattis.</p>
                <button className="buy w-[222px] h-[74px] px-[72px] py-[25px] bg-[#B88E2F] text-white border-[#B88E2F] sm:w-full sm:h-[50px] sm:py-[12px] sm:px-[20px]">Buy Now</button>
            </div>
            </div>
...
<div className="s-images w-1440 h-721">
